...
class Hostname(object):
    ...
    def __init__(self, hostname=None, _configuration=None):  # noqa: E501
    ...
    def hostname(self, hostname):
        ...
        if (self._configuration.client_side_validation and
                hostname is not None and len(hostname) > 63):
            raise ValueError("Invalid value for `hostname`, length must be less than or equal to `63`")  # noqa: E501
        if (self._configuration.client_side_validation and
        ...
        if (self._configuration.client_side_validation and
                hostname is not None and not re.search(r'^([a-zA-Z0-9]|[a-zA-Z0-9][a-zA-Z0-9-]*[a-zA-Z0-9])$', hostname)):  # noqa: E501
            raise ValueError(r"Invalid value for `hostname`, must be a follow pattern or equal to `/^([a-zA-Z0-9]|[a-zA-Z0-9][a-zA-Z0-9-]*[a-zA-Z0-9])$/`")  # noqa: E501
